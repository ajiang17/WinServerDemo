...
QT_MOC_LITERAL(1, 16, 12), // "updataserver"
...
QT_MOC_LITERAL(5, 61, 22) // "slotclientdisconnected"
    ...
    "TcpClientSocket\0updataserver\0\0"
...
void TcpClientSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TcpClientSocket::updataserver)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TcpClientSocket::updataserver(QString _t1, int _t2)
{
